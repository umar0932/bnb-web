        ...
        <div className='flex h-full flex-col lg:flex-row'>
          <div className='flex w-full flex-col bg-[#EFF8FF]  p-0 max-lg:order-2 sm:p-10 lg:w-1/2'>
            <div className='m-5 bg-white p-5 sm:p-10 '>
              <div className='flex flex-col'>
                <span className='text-3xl text-btnprimary'>Looking for events in</span>
                <Autocomplete />
              </div>
            </div>
          </div>
          <div className='flex w-full flex-col justify-center p-10 max-lg:order-1 lg:ml-10 lg:w-1/2'>
            <div className='flex flex-col gap-5'>
              ...
              <span className='text-xl text-[#757575]'>We'll save this location for you.</span>
              <div className='flex flex-col gap-2'>
                <Progress value={66} className='w-[70%] bg-[#B2DBFE] text-[#B2DBFE]' />
