...
export default function HelpCenter() {
  ...
  return (
    <>
      ...
      <div className="top[-22px] relative mx-auto flex  justify-center max-sm:flex-col ">
        <div className="flex max-w-[640px] flex-col   ">
          ...
          <div className="flex w-full flex-wrap justify-between  gap-8  p-10 max-lg:justify-center">
            <button className="field-drop-shadow flex items-center gap-4 rounded-lg p-3 px-5 text-xl">
      ...
      <div className="mt-10 flex flex-wrap justify-between gap-10 p-10 max-md:justify-center">
