...
export default function Interests() {
  ...
  const isGenreSelected = (genre: Genre, selectedGenres: Genre[]) =>
              ...
              {[
                ...
                <button
                  ...
                  className={getButtonClassName(
                    isGenreSelected(genre, selectedMusicGenres)
                  )}
                  onClick={() =>
                    toggleGenre(
                      genre,
            ...
            <div className="mt-3 flex flex-wrap gap-5 p-5">
              {["Bear", "Food", "Wine", "Others"].map((genre) => (
                <button
                  key={genre}
                  className={getButtonClassName(
                    isGenreSelected(genre, selectedFoodGenres)
                  )}
                  onClick={() =>
                    toggleGenre(
                      genre,
                      setSelectedFoodGenres,
                      selectedFoodGenres
                    )
                  }
                >
