            ...
            <div className='card-drop-shadow flex w-full  items-center  gap-5 rounded-lg bg-[#F6FBFF] p-5'>
              <div className='flex w-full flex-col gap-5'>
                ...
                <span className='text-md text-[#003A6D]'>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas molestie leo sed
                  turpis venenatis sagittisLorem ipsum dolor sit amet, consectetur adipiscing elit.
                  Maecenas molestie leo sed turpis venenatis sagittis Lorem ipsum dolor sit amet,
                  consectetur adipiscing elit. Maecenas molestie leo sed turpis venenatis
                  sagittisLorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas molestie
                  leo sed turpis venenatis sagittis
                </span>
              </div>
            </div>
          </div>
