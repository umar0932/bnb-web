  ...
  return (
    <>
      <div className="flex flex-col">
        ...
        {/* Event name and Date  */}
        <div className=" flex w-full flex-col gap-4 bg-secondary p-10">
          <div className="flex items-center justify-between max-sm:flex-col max-sm:justify-center max-sm:gap-3">
            ...
            <span className="text-3xl font-bold text-white max-lg:text-2xl">
              10 June
            </span>
          </div>
        ...
        <div className="flex flex-col gap-10 bg-white p-10">
          ...
          <div className="flex w-full justify-between gap-20 max-md:flex-col">
            ...
            <div className="card-drop-shadow flex w-[600px] flex-col gap-7 rounded-lg bg-[#F6FBFF] p-5 max-md:w-full">
              <div className="mt-2 flex justify-between">
                <span className="w-full text-lg font-bold text-primary">
                  General Admission
                </span>
              ...
              <div className=" flex flex-col gap-3">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className="flex w-full flex-col">
                    ...
                    <span className="pl-3 text-sm text-[#757575]">
                      9:00 PM GMT+5:00
                    </span>
                  </div>
                </div>
            ...
            <div className="card-drop-shadow flex w-full  items-center  gap-5 rounded-lg bg-[#F6FBFF] p-5">
              <div className="flex w-full flex-col gap-5">
                ...
                <span className="text-md text-[#003A6D]">
                  ...
                  Maecenas molestie leo sed turpis venenatis sagittisLorem ipsum
                  dolor sit amet, consectetur adipiscing elit. Maecenas molestie
                  leo sed turpis venenatis sagittis Lorem ipsum dolor sit amet,
                  consectetur adipiscing elit. Maecenas molestie leo sed turpis
                  venenatis sagittisLorem ipsum dolor sit amet, consectetur
                  adipiscing elit. Maecenas molestie leo sed turpis venenatis
                  sagittis
                </span>
              </div>
            </div>
          ...
          <div className="flex justify-end">
            <span className="cursor-pointer text-btnprimary underline">
              Report this event
            </span>
          </div>
        </div>
