        ...
        <div className="flex w-full flex-col">
          ...
          <div className="mt-5 flex  flex-col ">
            ...
            <span className="text-sm text-[#757575]">
              Thank you for using Bnb Events. If there is anything we can do to
              keep you with us, please{" "}
              <span className="underline">let us know.</span> Please take a
              moment to let us know why you are leaving:
            </span>
          </div>
            ...
            >
              ...
              <div className=" flex  flex-col gap-3">
                ...
                <span className="mt-2 text-sm">
                  Please enter "CLOSE" and your password to confirm that you
