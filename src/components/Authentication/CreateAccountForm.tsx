  ...
  return (
    <div className='flex w-full flex-col gap-6 md:gap-8'>
      ...
      <FormikProvider value={formik}>
        <form onSubmit={formik.handleSubmit} className='flex w-full flex-col gap-6 md:gap-8'>
          <InputField id='email' name='email' type='email' placeholder='Email' />
          <InputField id='firstName' name='firstName' type='text' placeholder='First Name' />
          <InputField id='lastName' name='lastName' type='text' placeholder='Last Name' />
